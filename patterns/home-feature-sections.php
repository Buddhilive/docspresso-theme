<?php
/**
 * Title: Feature Grid + CTA Band (Home)
 * Slug: docspresso/home-feature-sections
 * Categories: docspresso
 * Description: Three-column feature grid followed by a primary-colored call-to-action band, for the front page.
 */
?>
<!-- wp:group {"className":"mx-auto w-full max-w-content px-4 py-16 sm:px-6 sm:py-24 lg:px-8","layout":{"type":"constrained"}} -->
<div class="wp-block-group mx-auto w-full max-w-content px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
	...
	<!-- wp:columns {"className":"gap-8","layout":{"type":"flex","flexWrap":"wrap"}} -->
	<div class="wp-block-columns gap-8">

		<!-- wp:column {"className":"flex-1 min-w-[16rem] rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6"} -->
...
<div class="wp-block-group mx-auto w-full max-w-content px-4 pb-16 sm:px-6 sm:pb-24 lg:px-8">
	<!-- wp:group {"className":"docspresso-home-cta max-w-none rounded-2xl bg-primary-600","layout":{"type":"constrained"}} -->
	<div class="wp-block-group docspresso-home-cta max-w-none rounded-2xl bg-primary-600">
