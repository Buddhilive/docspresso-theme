...
<header id="masthead" class="relative bg-transparent">
    <div class="max-w-7xl mx-auto px-6">
        <!-- Hero area -->
        <div class="hero bg-slate-800 text-white rounded-lg overflow-hidden mb-12 mt-12">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-center px-16">
                <div class="md:col-span-7 py-16">
                ...
                <div class="md:col-span-5 aspect-video flex items-center justify-end">
